...
class VideoListEntry extends React.Component {
  ...
  render() {
    return (<div className="video-list-entry">
          ...
          <div className="media-body">
            <div onClick={this.props.onClickVideoTitle.bind(null, this.props.entry.id.videoId)} data-videoid={this.props.entry.id.videoId} className="video-list-entry-title">{this.props.entry.snippet.title}</div>
